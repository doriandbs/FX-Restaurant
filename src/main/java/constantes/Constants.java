...
public class Constants {
    ...
    public static final String connSucc = "CONNEXION REUSSIE";
    public static final String verifCh = "veuillez rentrer tous les champs";
    ...
    public static final String url = "jdbc:mysql://localhost:3306/projetrestaurant";
